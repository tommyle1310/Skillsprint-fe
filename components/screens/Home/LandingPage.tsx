...
import { Award, BookOpen, CheckCircle, CheckIcon, ChevronRight, ChevronRightIcon, Clock, Minus, Plus, Star, TrendingUp, Users, Zap, DollarSign, Gift, Share2, Timer, Target, Shield, Globe, Heart, ArrowRight, Mail, Download, Users2 } from 'lucide-react'
...
const LandingPage = () => {
  ...
  const pricingPlans = [
    {
      name: "Free",
      price: 0,
      features: ["3 free lessons", "Basic quizzes", "Community access", "Email support"],
      popular: false,
      cta: "Start Free"
    },
    {
      ...
      price: 29,
      originalPrice: 49,
      features: ["All courses", "Advanced quizzes", "1-on-1 mentoring", "Certificate", "Priority support"],
      popular: true,
      cta: "Get Pro"
    },
    {
      ...
      price: 99,
      originalPrice: 149,
      features: ["Everything in Pro", "Live workshops", "Career coaching", "Job placement", "24/7 support"],
      popular: false,
      cta: "Get Premium"
    }
  ];
  ...
  const companyLogos = [
    "Google", "Microsoft", "Netflix", "Amazon", "Meta", "Apple", "Tesla", "Uber"
  ];
  ...
  const caseStudies = [
    {
      ...
      quote: "SkillSprint's sequential learning helped me master AI concepts I struggled with for years. Now I'm leading AI projects at Google."
    },
    {
      name: "Mike Chen",
      ...
      quote: "The structured approach and real-world projects gave me the confidence to switch careers. I'm now managing tech products at Microsoft."
    }
  ];
  ...
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl font-bold text-slate-900 mb-4">
            Tại sao chọn SkillSprint thay vì nền tảng khác?
          </h2>
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            Chúng tôi không chỉ dạy bạn kiến thức, mà còn đảm bảo bạn thực sự hiểu và áp dụng được
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl border border-blue-200">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-2">Giảng viên hàng đầu</h3>
            <p className="text-slate-600">50+ chuyên gia từ Google, Microsoft, Netflix</p>
          </div>
          ...
          <div className="text-center p-6 bg-gradient-to-br from-green-50 to-green-100 rounded-2xl border border-green-200">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-2">Giá cả hợp lý</h3>
            <p className="text-slate-600">Chỉ $29/tháng cho tất cả khóa học</p>
          </div>
          ...
          <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl border border-purple-200">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-2">Học mọi lúc</h3>
            <p className="text-slate-600">24/7 truy cập, học trên mọi thiết bị</p>
          </div>
          ...
          <div className="text-center p-6 bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl border border-orange-200">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-2">Hoàn tiền 7 ngày</h3>
            <p className="text-slate-600">Đảm bảo 100% hài lòng hoặc hoàn tiền</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {bestDealCourses.map((course) => (
            <div key={course.id} className="bg-white rounded-2xl shadow-lg overflow-hidden border border-slate-200 hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-2">
                    <span className="text-3xl font-bold text-red-600">${course.salePrice}</span>
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
            {companyLogos.map((logo, index) => (
              <div key={index} className="text-2xl font-bold text-slate-400 hover:text-slate-600 transition-colors">
                {logo}
              </div>
            ))}
          </div>
          ...
          {caseStudies.map((study, index) => (
            <div key={index} className="bg-white rounded-2xl p-8 shadow-lg border border-slate-200">
              <div className="flex items-start space-x-4 mb-6">
                ...
                />
                <div>
                  <h3 className="text-xl font-bold text-slate-900">{study.name}</h3>
                  <p className="text-slate-600">{study.role} at {study.company}</p>
    ...
    <section className="py-16 bg-gradient-to-r from-green-600 to-blue-600">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <ShimmerButton background='black' className=" text-white hover:bg-slate-100 px-8 py-4 text-lg">
            Get Started Free
            <ArrowRight className="w-5 h-5 ml-2" />
          </ShimmerButton>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-3xl p-12 text-center border border-purple-200">
          ...
          <p className="text-xl text-slate-600 mb-8 max-w-2xl mx-auto">
            Join 50,000+ professionals and get instant access to our exclusive AI cheat sheet, 
            plus weekly tips to accelerate your learning journey.
          </p>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-3xl p-12 text-center shadow-lg border border-slate-200">
          ...
          <p className="text-xl text-slate-600 mb-8">
            Share SkillSprint with your network and both of you get $5 voucher for each successful referral
          </p>
          
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="text-center p-6 bg-green-50 rounded-xl">
              <Users2 className="w-12 h-12 text-green-600 mx-auto mb-3" />
              <h3 className="text-lg font-semibold text-slate-900 mb-2">Invite Friends</h3>
              <p className="text-slate-600">Share your unique referral link</p>
            </div>
            <div className="text-center p-6 bg-blue-50 rounded-xl">
              <CheckCircle className="w-12 h-12 text-blue-600 mx-auto mb-3" />
              <h3 className="text-lg font-semibold text-slate-900 mb-2">They Join</h3>
              <p className="text-slate-600">Your friends sign up and start learning</p>
            </div>
            <div className="text-center p-6 bg-purple-50 rounded-xl">
              <DollarSign className="w-12 h-12 text-purple-600 mx-auto mb-3" />
              <h3 className="text-lg font-semibold text-slate-900 mb-2">Both Get $5</h3>
              <p className="text-slate-600">You and your friend get vouchers</p>
            </div>
          </div>
